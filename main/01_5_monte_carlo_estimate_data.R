...
compute_bias <-
  function(
    ...
    worker1 <- min(match_effect_monte_carlo_data$worker_id)
    category1 <- min(match_effect_monte_carlo_data$category_id)
  match11 <-
    ...
    bias <-
      ...
      c(
        ...
        (list_worker_id[2:num_agent] - worker1) + 
        ...
        (list_category_id[2:num_category] - category1) + 
